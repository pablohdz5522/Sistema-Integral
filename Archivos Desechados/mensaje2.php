...
<body>
    <div class="contenedor">
        <div class="mensaje">
            Ya has respondido este cuestionario anteriormente.
        </div>
        <div class="subtitulo">
            No puedes volver a enviarlo. Si necesitas modificar alguna respuesta, por favor contacta al administrador.
        </div>
