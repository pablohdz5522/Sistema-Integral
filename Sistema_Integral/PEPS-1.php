        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 col-md-8 col-sm-10 col-12">
                ...
                <div class="mt-4" style="display: block;" id="instrucciones">
                    ...
                    <p style="margin-top: -15px; font-weight: bolder;">a) En este cuestionario se pregunta sobre el modo
                        en que vives en relación a tus hábitos personales actuales.</p>
                    <p style="margin-top: -15px; font-weight: bolder;">b) No hay respuesta correcta o incorrecta, solo
                        es tu forma de vivir. Favor de no dejar preguntas sin responder. </p>
                    <p style="margin-top: -15px; font-weight: bolder;">c) Escoge una respuesta que refleje mejor tu
                        forma de vivir.</p>
                    <p class="text-center mt-5" style="font-weight: bolder;">1=Nunca, 2=A veces, 3=Frecuentemente,
                        4=Rutinariamente</p>
                </div>
                ...
                <form action="PEPS-1.php" method="post" style="display: block;" id="formulario">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p2" class="form-label">2. Relatas al médico cualquier síntoma extraño relacionado
                            con tu salud</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p4" class="form-label">4. Realizas ejercicios para relajar tus músculos al menos 3
                            veces por día o por semana </label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p5" class="form-label">5. seleccionas comidas que no contienen ingredientes
                            artificiales o químicos para conservarlos (sustancias que te eleven tu presión arterial)
                        </label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">8. Eres entusiasta y optimista con referencia a tu
                            vida</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">9. Crees que estás creciendo y cambiando personalmente en
                            direcciones positivas</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">11. Eres consciente de las fuentes que producen tensión
                            (Comúnmente nervios) en tu vida</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">13. Realizas ejercicio vigoroso por 20 o 30 minutos al menos
                            tres veces a la semana</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">15. Lees revistas o folletos sobre como cuidar tu
                            salud</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">16. Eres consciente de tus capacidades y debilidades
                            personales</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">17. Trabajas en apoyo de metas a largo plazo en tu
                            vida</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">18. Elogias fácilmente a otras personas por sus
                            éxitos</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">19. Lees las etiquetas de las comidas empaquetadas para
                            identificar nutrientes (artificiales y/o naturales, colesterol,
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">20. Le preguntas a otro médico o buscas otra opción cuando no
                            estas de acuerdo con lo que el tuyo te recomienda para cuidar tu salud</label>
                        <div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">22. Participas en programas o actividades de ejercicio físico
                            bajo supervisión</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p22" id="p22_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p22_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p22" id="p22_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p22_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p22" id="p22_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p22_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p22" id="p22_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p23" id="p23_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p23_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p23" id="p23_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p23_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p23" id="p23_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p23_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p23" id="p23_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">24. Te gusta expresar y que te expresen cariño personas
                            cercanas a ti</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p24" id="p24_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p24_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p24" id="p24_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p24_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p24" id="p24_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p24_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p24" id="p24_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">25. Mantienes relaciones interpersonales que te dan
                            satisfacción</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p25" id="p25_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p25_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p25" id="p25_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p25_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p25" id="p25_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p25_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p25" id="p25_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">26. Incluyes en tu dieta alimentos que contienen fibra
                            (ejemplo: granos enteros, frutas crudas, verduras crudas)</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p26" id="p26_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p26_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p26" id="p26_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p26_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p26" id="p26_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p26_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p26" id="p26_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">27. Pasas de 15 a 20 minutos diariamente en relajamiento o
                            meditación</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p27" id="p27_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p27_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p27" id="p27_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p27_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p27" id="p27_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p27_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p27" id="p27_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">28. Discutes con profesionales calificados tus inquietudes
                            respecto al cuidado de tu salud</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p28" id="p28_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p28_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p28" id="p28_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p28_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p28" id="p28_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p28_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p28" id="p28_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p29" id="p29_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p29_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p29" id="p29_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p29_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p29" id="p29_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p29_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p29" id="p29_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p30" id="p30_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p30_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p30" id="p30_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p30_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p30" id="p30_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p30_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p30" id="p30_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p31" id="p31_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p31_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p31" id="p31_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p31_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p31" id="p31_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p31_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p31" id="p31_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">32. Haces medir tu presión arterial y sabes el
                            resultado</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p32" id="p32_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p32_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p32" id="p32_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p32_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p32" id="p32_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p32_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p32" id="p32_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">33. Asistes a programas educativos sobre el mejoramiento del
                            medio ambiente en que vives</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p33" id="p33_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p33_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p33" id="p33_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p33_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p33" id="p33_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p33_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p33" id="p33_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p34" id="p34_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p34_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p34" id="p34_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p34_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p34" id="p34_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p34_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p34" id="p34_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">35. Planeas o escoges comidas que incluyan los cuatro grupos
                            básicos de nutrientes cada día (Proteínas, carbohidratos, grasas y vitaminas)</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p35" id="p35_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p35_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p35" id="p35_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p35_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p35" id="p35_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p35_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p35" id="p35_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">36. Relajas conscientemente tus musculos antes de
                            dormir</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p36" id="p36_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p36_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p36" id="p36_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p36_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p36" id="p36_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p36_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p36" id="p36_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">37. Encuentras agradable y satisfecho el ambiente de tu
                            vida</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p37" id="p37_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p37_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p37" id="p37_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p37_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p37" id="p37_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p37_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p37" id="p37_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">38. Realizas actividades físicas de recreo como caminar,
                            nadar, jugar futbol, ciclisco</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p38" id="p38_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p38_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p38" id="p38_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p38_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p38" id="p38_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p38_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p38" id="p38_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">39. Expresas fácilmente interés, amor y calor humano hacia
                            otros</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p39" id="p39_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p39_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p39" id="p39_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p39_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p39" id="p39_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p39_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p39" id="p39_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">40. Te concentras en pensamientos agradables a la hora de
                            dormir</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p40" id="p40_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p40_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p40" id="p40_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p40_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p40" id="p40_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p40_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p40" id="p40_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">41. Pides información a los profesionales para cuidar de tu
                            salud</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p41" id="p41_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p41_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p41" id="p41_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p41_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p41" id="p41_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p41_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p41" id="p41_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">42. Encuentras maneras positivas para expresar tus
                            sentimientos</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p42" id="p42_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p42_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p42" id="p42_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p42_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p42" id="p42_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p42_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p42" id="p42_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">43. Observas al menos cada mes tu cuerpo para ver cambios
                            físicos o señas de peligro</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p43" id="p43_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p43_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p43" id="p43_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p43_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p43" id="p43_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p43_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p43" id="p43_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p44" id="p44_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p44_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p44" id="p44_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p44_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p44" id="p44_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p44_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p44" id="p44_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">45. Usas métodos específicos para controlar la tensión
                            (nervios)</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p45" id="p45_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p45_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p45" id="p45_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p45_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p45" id="p45_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p45_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p45" id="p45_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">46. Asistes a programas educativos sobre el cuidado de la
                            salud personal</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p46" id="p46_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p46_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p46" id="p46_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p46_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p46" id="p46_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p46_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p46" id="p46_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro">
                        <label for="p6" class="form-label">47. Te gusta mostrar y que te muestren afecto con palmadas,
                            abrazos y caricias, por personas que te importan
                            (papás, familiares, profesores y amigos)</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p47" id="p47_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p47_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p47" id="p47_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p47_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p47" id="p47_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p47_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p47" id="p47_rutina"
                                    value="4" required>
                    ...
                    <div class="mt-3 cuadro" style="margin-bottom: 20px;">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p48" id="p48_nunca"
                                    value="1" required>
                                <label class="form-check-label" for="p48_nunca">Nunca</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p48" id="p48_aveces"
                                    value="2" required>
                                <label class="form-check-label" for="p48_aveces">A veces</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p48" id="p48_frecuente"
                                    value="3" required>
                                <label class="form-check-label" for="p48_frecuente">Frecuentemente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input colorradio" type="radio" name="p48" id="p48_rutina"
                                    value="4" required>
