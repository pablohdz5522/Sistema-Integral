            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8 col-sm-10 col-12">
                    ...
                    <div class="mt-4" style="display: block;" id="instrucciones">
                        ...
                        <p style="margin-top: -15px; font-weight: bolder;">Por favor lea las siguientes afirmaciones y indica lo que le ha ocurrido a usted esta afirmacion *durante la semana pasada*.</p>
                        <p style="margin-top: -15px; font-weight: bolder;">La escala de calificación se encuentra en el boton.</p>
                    </div>
                    ...
                    <form action="DASS-21.php" method="post" style="display: block;" id="formulario">
                        ...
                        <div class="mt-5">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p1" id="p1_nunca" value="0" required>
                                    <label class="form-check-label" for="p1_nunca">0</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p1" id="p1_aveces" value="1" required>
                                    <label class="form-check-label" for="p1_aveces">1</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p1" id="p1_frecuente" value="2" required>
                                    <label class="form-check-label" for="p1_frecuente">2</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p1" id="p1_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                               <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p2" id="p2_nunca" value="0" required>
                                    <label class="form-check-label" for="p2_nunca">0</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p2" id="p2_aveces" value="1" required>
                                    <label class="form-check-label" for="p2_aveces">1</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p2" id="p2_frecuente" value="2" required>
                                    <label class="form-check-label" for="p2_frecuente">2</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input colorradio" type="radio" name="p2" id="p2_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p3" id="p3_nunca" value="0" required>
                                     <label class="form-check-label" for="p3_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p3" id="p3_aveces" value="1" required>
                                     <label class="form-check-label" for="p3_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p3" id="p3_frecuente" value="2" required>
                                     <label class="form-check-label" for="p3_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p3" id="p3_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p4" id="p4_nunca" value="0" required>
                                     <label class="form-check-label" for="p4_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p4" id="p4_aveces" value="1" required>
                                     <label class="form-check-label" for="p4_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p4" id="p4_frecuente" value="2" required>
                                     <label class="form-check-label" for="p4_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p4" id="p4_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            <label for="p5" class="form-label">5. Se me hizo difícil tomar la iniciativa para hacer cosas...</label>
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p5" id="p5_nunca" value="0" required>
                                     <label class="form-check-label" for="p5_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p5" id="p5_aveces" value="1" required>
                                     <label class="form-check-label" for="p5_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p5" id="p5_frecuente" value="2" required>
                                     <label class="form-check-label" for="p5_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p5" id="p5_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p6" id="p6_nunca" value="0" required>
                                     <label class="form-check-label" for="p6_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p6" id="p6_aveces" value="1" required>
                                     <label class="form-check-label" for="p6_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p6" id="p6_frecuente" value="2" required>
                                     <label class="form-check-label" for="p6_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p6" id="p6_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p7" id="p7_nunca" value="0" required>
                                     <label class="form-check-label" for="p7_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p7" id="p7_aveces" value="1" required>
                                     <label class="form-check-label" for="p7_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p7" id="p7_frecuente" value="2" required>
                                     <label class="form-check-label" for="p7_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p7" id="p7_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            <label for="p6" class="form-label">8. He sentido que estaba gastando una gran cantidad de energía...</label>
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p8" id="p8_nunca" value="0" required>
                                     <label class="form-check-label" for="p8_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p8" id="p8_aveces" value="1" required>
                                     <label class="form-check-label" for="p8_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p8" id="p8_frecuente" value="2" required>
                                     <label class="form-check-label" for="p8_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p8" id="p8_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            <label for="p6" class="form-label">9. Estaba preocupado por situaciones en las cuales podía tener pánico o en las que podría 
                                hacer el ridículo...</label>
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p9" id="p9_nunca" value="0" required>
                                     <label class="form-check-label" for="p9_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p9" id="p9_aveces" value="1" required>
                                     <label class="form-check-label" for="p9_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p9" id="p9_frecuente" value="2" required>
                                     <label class="form-check-label" for="p9_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p9" id="p9_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p10" id="p10_nunca" value="0" required>
                                     <label class="form-check-label" for="p10_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p10" id="p10_aveces" value="1" required>
                                     <label class="form-check-label" for="p10_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p10" id="p10_frecuente" value="2" required>
                                     <label class="form-check-label" for="p10_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p10" id="p10_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p11" id="p11_nunca" value="0" required>
                                     <label class="form-check-label" for="p11_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p11" id="p11_aveces" value="1" required>
                                     <label class="form-check-label" for="p11_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p11" id="p11_frecuente" value="2" required>
                                     <label class="form-check-label" for="p11_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p11" id="p11_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p12" id="p12_nunca" value="0" required>
                                     <label class="form-check-label" for="p12_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p12" id="p12_aveces" value="1" required>
                                     <label class="form-check-label" for="p12_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p12" id="p12_frecuente" value="2" required>
                                     <label class="form-check-label" for="p12_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p12" id="p12_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p13" id="p13_nunca" value="" required>
                                     <label class="form-check-label" for="p13_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p13" id="p13_aveces" value="1" required>
                                     <label class="form-check-label" for="p13_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p13" id="p13_frecuente" value="2" required>
                                     <label class="form-check-label" for="p13_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p13" id="p13_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            <label for="p6" class="form-label">14. No toleré nada que no me permitiera continuar con lo que estaba haciendo...</label>
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p14" id="p14_nunca" value="0" required>
                                     <label class="form-check-label" for="p14_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p14" id="p14_aveces" value="1" required>
                                     <label class="form-check-label" for="p14_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p14" id="p14_frecuente" value="2" required>
                                     <label class="form-check-label" for="p14_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p14" id="p14_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p15" id="p15_nunca" value="0" required>
                                     <label class="form-check-label" for="p15_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p15" id="p15_aveces" value="1" required>
                                     <label class="form-check-label" for="p15_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p15" id="p15_frecuente" value="2" required>
                                     <label class="form-check-label" for="p15_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p15" id="p15_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p16" id="p16_nunca" value="0" required>
                                     <label class="form-check-label" for="p16_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p16" id="p16_aveces" value="1" required>
                                     <label class="form-check-label" for="p16_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p16" id="p16_frecuente" value="2" required>
                                     <label class="form-check-label" for="p16_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p16" id="p16_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p17" id="p17_nunca" value="0" required>
                                     <label class="form-check-label" for="p17_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p17" id="p17_aveces" value="1" required>
                                     <label class="form-check-label" for="p17_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p17" id="p17_frecuente" value="2" required>
                                     <label class="form-check-label" for="p17_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p17" id="p17_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p18" id="p18_nunca" value="0" required>
                                     <label class="form-check-label" for="p18_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p18" id="p18_aveces" value="1" required>
                                     <label class="form-check-label" for="p18_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p18" id="p18_frecuente" value="2" required>
                                     <label class="form-check-label" for="p18_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p18" id="p18_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            <label for="p6" class="form-label">19. Sentí los latidos de mi corazón a pesar de no haber hecho ningún esfuerzo físico...</label>
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p19" id="p19_nunca" value="0" required>
                                     <label class="form-check-label" for="p19_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p19" id="p19_aveces" value="1" required>
                                     <label class="form-check-label" for="p19_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p19" id="p19_frecuente" value="2" required>
                                     <label class="form-check-label" for="p19_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p19" id="p19_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p20" id="p20_nunca" value="0" required>
                                     <label class="form-check-label" for="p20_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p20" id="p20_aveces" value="1" required>
                                     <label class="form-check-label" for="p20_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p20" id="p20_frecuente" value="2" required>
                                     <label class="form-check-label" for="p20_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p20" id="p20_rutina" value="3" required>
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p21" id="p21_nunca" value="0" required>
                                     <label class="form-check-label" for="p21_nunca">0</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p21" id="p21_aveces" value="1" required>
                                     <label class="form-check-label" for="p21_aveces">1</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p21" id="p21_frecuente" value="2" required>
                                     <label class="form-check-label" for="p21_frecuente">2</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                     <input class="form-check-input colorradio" type="radio" name="p21" id="p21_rutina" value="3" required>
